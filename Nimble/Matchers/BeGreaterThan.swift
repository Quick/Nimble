...
func beGreaterThan(expectedValue: NMBComparable?) -> MatcherFunc<NMBComparable?> {
    return MatcherFunc { actualExpression, failureMessage in
        ...
        let matches = actualValue && actualValue!.NMB_compare(expectedValue) == NSComparisonResult.OrderedDescending
        return matches
    }
}
...
extension NMBObjCMatcher {
    class func beGreaterThanMatcher(expected: NMBComparable?) -> NMBObjCMatcher {
