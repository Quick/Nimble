...
final class UserDescriptionTest: XCTestCase {
    func testToMatcher_CustomFailureMessage() {
        failsWithErrorMessage(
            ...
            expect(1).to(Predicate.simple("match") { _ in .matches }, description: "These aren't equal!")
        }
    }
    ...
    func testNotToMatcher_CustomFailureMessage() {
        failsWithErrorMessage(
            ...
            expect(1).notTo(Predicate.simple("match") { _ in .matches }, description: "These aren't equal!")
        }
    }
    ...
    func testToNotMatcher_CustomFailureMessage() {
        failsWithErrorMessage(
            ...
            expect(1).toNot(Predicate.simple("match") { _ in .matches }, description: "These aren't equal!")
        }
    }
